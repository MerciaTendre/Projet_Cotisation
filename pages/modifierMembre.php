...
<body>
  ...
  <div class="form-group col-sm-6">
    ...
    <input type="Date" class="form-control" id="datedenaissance" name="datedenaissance" value="<?php echo $membres['DateNaissance']?>" placeholder="votre Date de naissance">
  </div>
  <div class="form-group col-sm-6">
  ...
  <button type="submit" id="enregistrement" name="Enregistrer" class="btn btn-primary mt-3">
  Submit
</script>
</button> 
...
<script src = "../cdnjs/alert.js " > </script> 
</body>
</html>